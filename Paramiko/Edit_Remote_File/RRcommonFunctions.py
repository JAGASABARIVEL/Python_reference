...
class ConfigureSRT(object):
    ...
    def post_to_rm_srt(self, cfg):
        ...
        try:
            ...
            for rr in rrhosts:
                ...
                if isaws:
                    client1.connect(rr, username="centos", allow_agent=True)
                else:
                ...
                client1.exec_command(
                    "sudo cp -f /tmp/static_route_table.txt /opt/cisco/gosrm/ConfigFiles/rioRecorder/static_route_table.txt")
    ...
    def change_srt_file(self, cfg, srt_name="static_route_table.txt", revert=False,
                        default_srt="static_route_table.txt"):
        """
        ...
        try:
            ...
            for rr in rrhosts:
                ...
                if revert:
                    i, o, e = client1.exec_command(
                        "mv /opt/cisco/gosrm/ConfigFiles/rioRecorder/%s /opt/cisco/gosrm/ConfigFiles/rioRecorder/%s" % (
                        srt_name, default_srt))
                else:
                    i, o, e = client1.exec_command(
                        "mv /opt/cisco/gosrm/ConfigFiles/rioRecorder/%s /opt/cisco/gosrm/ConfigFiles/rioRecorder/%s" % (
                        default_srt, srt_name))

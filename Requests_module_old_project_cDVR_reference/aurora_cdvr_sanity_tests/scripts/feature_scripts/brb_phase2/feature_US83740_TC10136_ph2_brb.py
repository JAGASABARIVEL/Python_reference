...
#########################################################################
# TestcaseId: TC10136
# TestcaseSteps: BRB - Dual VMR - Redirect the request from all VMR from all channels to a specific VMR.
...
# STEP 3: Modify the SRT in such a way to record the contents from any region and from any channel with default copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect the request from all VMR from all channels to a specific VMR." % (test_id)
    ...
    try:
        ...
        srt_content = [["*", "*", dest_region, "NoChange"]]
        ...
        eventtitle1 = "TC10136" + str(random.randint(1, 499))

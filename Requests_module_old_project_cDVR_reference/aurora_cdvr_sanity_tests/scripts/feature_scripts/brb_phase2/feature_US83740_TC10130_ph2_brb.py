...
#########################################################################
# TestcaseId: TC10130
# TestcaseSteps: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for all channels.
...
# STEP 3. Modify the SRT in such a way to record the contents from any channel with default copy type in RR2 recording region.
#
#          RR1|*|RR2|NoChange
#
...
#    STEP6.1. Content from channel 2 recorded on hh3 & hh4 with default copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for all channels." % (test_id)
    ...
    try:
        ...
        srt_content = [[source_region, "*", dest_region, "NoChange"]]
        ...
        eventtitle1 = "TC10130" + str(random.randint(1, 499))

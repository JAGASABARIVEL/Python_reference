...
#########################################################################
# TestcaseId: TC10128
# TestcaseSteps: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for a single channel with unique copy type.
...
# STEP 3. Modify the SRT in such a way to record the contents from channel 1 with unique copy type in RR2 recording region.
#
#          RR1|CH1|RR2|Unique
#
...
#    STEP 6.1. Content from channel 1 booked on hh1 & hh2 with unique copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for a single channel with unique copy type." % (test_id)
    ...
    try:
        ...
        srt_content = [[source_region, str(testchannel1_uuid), dest_region, "Unique"]]
        ...
        eventtitle1 = "TC10128" + str(random.randint(1, 499))

...
#########################################################################
# TestcaseId: TC10135
# TestcaseSteps: BRB - Dual VMR - Redirect the request from all VMR from a single channel to a specific VMR with Common copy type.
...
# STEP 3. Modify the SRT in such a way to record the contents from any region and from channel 1 with common copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect the request from all VMR from a single channel to a specific VMR with Common copy type." % (test_id)
    ...
    try:
        ...
        srt_content = [["*", str(testchannel1_uuid), dest_region, "Common"]]
        ...
        eventtitle1 = "TC10135" + str(random.randint(1, 499))

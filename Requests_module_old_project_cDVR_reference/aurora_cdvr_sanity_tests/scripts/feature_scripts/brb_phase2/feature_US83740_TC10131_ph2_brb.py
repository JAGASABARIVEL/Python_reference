...
#########################################################################
# TestcaseId: TC10131
# TestcaseSteps: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for all channels with unique copy type.
...
# STEP 3: Modify the SRT in such a way to record the contents from any channel with unique copy type in RR2 recording region.
#
#          RR1|*|RR2|Unique
#
...
#    STEP 6.1: Content from channel 2 recorded on hh3 & hh4 with unique copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect recording before scheduling from VMR1 to VMR2 for all channels with unique copy type." % (test_id)

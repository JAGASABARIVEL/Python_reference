...
#########################################################################
# TestcaseId: TC10134
# TestcaseSteps: BRB - Dual VMR - Redirect the request from all VMR from a single channel to a specific VMR with Unique copy type.
...
# STEP 3: Modify the SRT in such a way to record the contents from any region and from channel 1 with unique copy type in RR2 recording region.
...
#    STEP 6.1: Content from channel 1 recorded on hh1 & hh2 with unique copy type in RR2 recording region.
#    STEP 6.2: Content from channel 2 recorded on hh3 & hh4 with default copy type in RR2 recording region.
...
def doit_wrapper(cfg, printflg=False):
    ...
    print "%s: BRB - Dual VMR - Redirect the request from all VMR from a single channel to a specific VMR with Unique copy type." % (test_id)
    ...
    try:
        ...
        srt_content = [["*", str(testchannel1_uuid), dest_region, "Unique"]]
        ...
        eventtitle1 = "TC10134" + str(random.randint(1, 499))

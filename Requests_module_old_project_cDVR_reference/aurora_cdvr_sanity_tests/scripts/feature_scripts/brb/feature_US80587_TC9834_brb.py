...
# STEP1: Ingest two events of n minutes with the posttime of n Minutes to the CI Host
...
# STEP8.1: Make the SRT table empty before EV3 and EV4 gets scheduled
...
# STEP12: Verify 4 unique copy recording.
########################################################################
...
def doit_wrapper(cfg, printflg=False):
    ...
    status = 3
    test_id = "TC9834"
    tims_dict = {test_id: ["US80592", message, status],}

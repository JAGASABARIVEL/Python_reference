...
# STEP8.1: Set SRT to Invalid CopyType before EV3 and EV4 gets scheduled
...
# STEP12: Verify 4 unique copy of recording
########################################################################
...
def doit_wrapper(cfg, printflg=False):
    ...
    try:
        ...
        srt_content_change2 = [[],]
        srt_content_change3 = [[source_region, "*", dest_region, "comon"],]
    ...
    for (cmdc_host, pps_host) in hostlist:
        try:
            ...
            print "### STEP8.1: Invaild SRT Table ###### \n \n"
            configureSRT_instance.modify_srt(cfg, srt_content_change3)

...
########################################################################################################################
# TestcaseId: TC9839, brb - rename the SRT file
# TestcaseSteps:
...
# Step9: Rename the SRT file to some other name
...
def doit_wrapper(cfg, printflg=False):
    ...
    for (cmdc_host, pps_host) in hostlist:
        try:
            ...
            print "All the recordings are present in the expected copy type (common - last known SRT before renaming.)"

...
########################################################################################################################
# TestcaseId: TC9838, brb - delete the SRT file
# TestcaseSteps:
# Step1: Ingest EV1 and EV2 of 6 minutes in 2 channels with the posttime of 10 Minutes to the CI Host
...
# Step9: Delete the SRT file
# Step10: Book UC EV3 from HH1, HH2 on CH1 and UC EV4 from HH3, HH4 on CH2
...
def doit_wrapper(cfg, printflg=False):
    ...
    for (cmdc_host, pps_host) in hostlist:
        try:
            ...
            print "All the recordings are present in the expected copy type (common - last known SRT before deleting.)"

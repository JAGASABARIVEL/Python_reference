"""
    TC9668: Big Red Button - static_routing_table.txt file edited - change only copyType
"""
...
from scripts.lib.brb_common_functions import ConfigureSRT

TESTCASE_STEPS = """
##########################################################################################
# TC9668: Big Red Button - static_routing_table.txt file edited - change only copyType
# STEP1: Ingest a event of 3 minutes on CH1
# CH1 |--EV1--|
# STEP2: Update SRT to Common copy
...
# STEP5: Verify the copy type of the recording is Common
##########################################################################################
"""

...
def doit_wrapper(cfg, printflg=False):
    ...
    try:
        ...
        hh2_content_start_index = 0
        hh2_content_end_index = 1
        hh3_content_start_index = 0
        hh3_content_end_index = 1
        hh4_content_start_index = 0
        hh4_content_end_index = 1
        recording_delay = 60
            ...
            for householdid in householdid_list[:1]:
                for content_ev1, payload_ev1 in zip(
                    ...
                    if result != "PASS":
                        ...
                        print message
                        tims_dict = update_tims_data(
                            tims_dict, 1, message, [test_id, test_id2])

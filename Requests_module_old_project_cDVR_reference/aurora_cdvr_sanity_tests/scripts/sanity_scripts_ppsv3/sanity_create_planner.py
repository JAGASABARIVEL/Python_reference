...
class TestPlannerCreate(object):

    """
            Sanity test to check create planner operation is successfull.
    """
    ...
    def __init__(self, cfg, printflg=False):
        ...
        self.TC_PHASES.update({'2. CREATING PLANNERS': self.triggerCreation})
        self.kickTest()
    ...
    def kickTest(self):
        try:
            ...
            self.message = "Testcase Passed : Successfully able to create planner and working as expected"
    ...
    def setConfig(self):
        ...
        print "US: As a SP, I want an API to create a planner"
...
def doit_wrapper(cfg, printflg=False):
    create = TestPlannerCreate(cfg, printflg=False)

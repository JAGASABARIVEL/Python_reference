...
class TestIngestionEvent(object):
    """
            Sanity test to check wheteher ingestion of an event and series are successfull.
    """
    ...
    def __init__(self, cfg, printflg=False, import_=False):
        ...
        self.TC_PHASES.update(
            {'2. CREATING AND PACKING INGEST OBJECT': self.ingestEvent})
    ...
    def kickTest(self):
        try:
            ...
            self.message = "Testcase Passed : Event ingestion operations is working as expected."
            ...
            print "=" * 30
            print "4. CLEANUP PHASE IS NOT VALID IN THIS TC"
            print "=" * 30
            print self.message
...
def doit_wrapper(cfg, printflg=False):
    create = TestIngestionEvent(cfg, printflg=False)

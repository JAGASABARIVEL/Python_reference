    ...
    for index,v2pmasternode  in enumerate(v2p_masterNode):
        ...
        if workflow_name_list is None:
            ...
            for workflowname in workflow_name_list:
                url = v2p_protocol + "://" + v2pmasternode + ":" + str(port2) + "/v1/assetworkflows/" + workflowname 
                                ...
                                if val['name'] == workflowname:                 
                                    ...
                                    for value in variant:
                                        if value['publishUrl']:
                                            ...
                                            if publish_url.endswith(url_verify_string) == True:
                                                url_state = url_state + 1
                                                message = "Url for workflowname: " + workflowname + " : " + value['publishUrl']
                                                message_list.append(message)
                                            else:
                                                print "\n" + "#"*20 + " DEBUG STARTED "+ "#"*20+ "\n"

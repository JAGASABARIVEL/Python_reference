...
def doit(cfg,printflg=False):
    ...
    for index, host in enumerate(hosts):
        ...
        url = protocol + "://" + host + ":" + str(port) + "/upm/households/" + householdid + "/locale"
        print "Get Locale via " + url
    ...
    if  any_host_pass :
         msg = 'Testcase passed :Get locale ran successfully.'
         print msg
         ...
         msg = 'Testcase failed :Get locale was not successful.'
         print msg
         TIMS_testlog.append(1)
         TIMS_testlog.append(msg)
         return TIMS_testlog

...
def doit(cfg,printflg=False):
    ...
    try:
        ...
        url = v2p_protocol + "://" + pam_Node + ":" + str(port) + "/v2/cosnodes"
            ...
            if ( r.status_code != 200):
                ...
                for value in responce:
                    if value['properties']['adminState'] == 'inservice':
                        message = "Admin state is 'inservice' for id: " + value['id']
                        ...
                        print "\n" + "#"*20 + " DEBUG ENDED "+ "#"*20+ "\n"
                        check = check + 1
                        message = "Admin state is not 'inservice' for id: " + value['id'] 
                        message_list.append(message)
        else:
        ...
        if check:
            ...
            TIMS_testlog.append(1)
            TIMS_testlog.append('Get all cos node objects was not successful ' + message)
            return TIMS_testlog
        else:

...
def doit(cfg,printflg=False):
    ...
    for index,v2pmasternode  in enumerate(v2p_masterNode):
        ...
        url = v2p_protocol + "://" + v2pmasternode + ":" + str(port) + "/sm/v2/type/nodestatuses"
            ...
            if ( r.status_code != 200):
                ...
                for value in responce:
                    if value['properties']['state'] == 'inuse' or value['properties']['state'] == 'idle':
                        ...
                        message = "state for id: " + value['id'] + ": "  + value['properties']['state'] + " for v2p master node: " + v2pmasternode
                        print message   
                        message = "faultDetail for id: " + value['id'] + ": "  + value['properties']['faultDetail'] + " for v2p master node: " + v2pmasternode
                        print message   
                if state_check == 0:
